...
const RegistrationForm = (props) => {
    ...
    <div key="user-registration">
        ...
        <form onSubmit={handleSubmitRegistration} className="add-city-form" key="user-registration-form">
            ...
            <MDBInput key="input-4" type="password" name="registration-password" id="registration-password" value={registrationPassword} label="password" onChange={handleChangeRegistration} required/>
