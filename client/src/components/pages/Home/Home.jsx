...
const Home = (props) => {
    ...
    return (
        <div>
            ...
            <div className="center">
                <MDBBtn outline color="elegant" onClick={() =>handleRedirect(featuredWalks[0].walk.toLowerCase().replace(/ /g, '-'))}>Explore</MDBBtn>
            </div>
            <div className="center">
            ...
            <div className="center">
                <MDBBtn outline color="elegant" onClick={() =>handleRedirect(featuredWalks[1].walk.toLowerCase().replace(/ /g, '-'))}>Explore</MDBBtn>
            </div>
            <div className="center">
            ...
            <div className="center">
                <MDBBtn outline color="elegant" onClick={() =>handleRedirect(featuredWalks[2].walk.toLowerCase().replace(/ /g, '-'))}>Explore</MDBBtn>
            </div>
        </div>
    )
}
